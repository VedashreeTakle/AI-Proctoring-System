...
os.makedirs(os.path.join(evidence_dir, "screenshots"), exist_ok=True)  # Changed from "screenshotz" to "screenshots"
...
def process_video():
    global prev_lip_distance, current_frame
...
if __name__ == "__main__":
    # If run as script, start the proctoring directly
    main()
    
    # If you want to run the Flask app instead:
